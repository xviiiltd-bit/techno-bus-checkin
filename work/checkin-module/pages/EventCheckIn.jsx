...
const copy = {
  ...
  en: {
    ...
    duplicateError: "Multiple registrations found. Please tap your name to check in.",
    ...
    staffRequired: "Tap your name to check in",
    noEmail: "No email",
    ticket: "Ticket",
    loading: "Checking in...",
    submit: "Check in",
